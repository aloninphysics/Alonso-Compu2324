...
int main()
{
    double t, tmax=100, h=0.001, H, g=9.8;
    double K1[4], K2[4], K3[4], K4[4];
    double X1, X2, Y1, Y2, y1, y2, y3, y4;    //coordenadas de las masas de los pendulos
...

    {
      ...
      fdiagramas15=fopen("Diagrama_Poincare_E15.txt", "w");
    }
...
//Escribimos los valores de las 4 variables en 2 lanzamientos en un fichero para estudiar los coeficientes de Lyapunov.
