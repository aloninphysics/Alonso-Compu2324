...
# Ruta del archivo
file = 'c:/Users/Alonso/Desktop/FISICACOMPUTACIONAL/Git/RepositorioGit/Alonso-Compu2324/voluntarios/voluntario1/Lyapunov/Lyapunov_Exponentes.txt'
...
# Configurar los pasos del eje X para que sean solo 1, 3, 5, 10, 15
plt.xticks([1, 3, 5, 10, 15])

# Añadir título y etiquetas
plt.title('Dependencia de los coeficientes de Lyapunov con la Energía H')
plt.xlabel('H inicial')
