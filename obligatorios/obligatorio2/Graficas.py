...
x, y, errx, erry = load_data_from_file("C:/Users/Alonso/Desktop/FISICACOMPUTACIONAL/Git/RepositorioGit/Alonso-Compu2324/obligatorios/obligatorio2/tiempos.txt")
x1, y1, errx1, erry1 = load_data_from_file("C:/Users/Alonso/Desktop/FISICACOMPUTACIONAL/Git/RepositorioGit/Alonso-Compu2324/obligatorios/obligatorio2/tiemposjoel.txt")
...
plt.xlabel('t(s)')
plt.ylabel('N espines')
plt.title('Comparación del tiempo de ejecución entre mi PC y Joel')
